...
static plat_thermal_t plat_thermals[] = {
    ...
    [PLAT_THERMAL_ID_7] = {
        ...
        .temp_get_path     = "/sys/bus/i2c/devices/0-004a/hwmon/*/temp1_input",

        .warning_get_path  = "/sys/bus/i2c/devices/0-004a/hwmon/*/temp1_max_hyst",
        .critical_get_path = NULL,
        .shutdown_get_path = "/sys/bus/i2c/devices/0-004a/hwmon/*/temp1_max",
    ...
    [PLAT_THERMAL_ID_8] = {
        ...
        .temp_get_path     = "/sys/bus/i2c/devices/0-004b/hwmon/*/temp1_input",

        .warning_get_path  = "/sys/bus/i2c/devices/0-004b/hwmon/*/temp1_max_hyst",
        .critical_get_path = NULL,
        .shutdown_get_path = "/sys/bus/i2c/devices/0-004b/hwmon/*/temp1_max",
